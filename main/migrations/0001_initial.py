    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Audio', 'Audio'), ('Home', 'Home'), ('Accessories', 'Accessories')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='MyUser',
        ...
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(related_name='carts', through='main.CartItem', to='main.product'),
        ),
    ]
